...
public final class ArmorCondition extends AbstractCondition {
    ...
    public Text getDescription() {
        return switch (mode) {
            case NONE -> ModI18n.text("condition.lumenechallenge.no_armor");
            case FULL -> ModI18n.text("condition.lumenechallenge.full_armor");
            case HELMET_ONLY -> ModI18n.text("condition.lumenechallenge.armor.helmet_only");
            case CHEST_ONLY -> ModI18n.text("condition.lumenechallenge.armor.chest_only");
            case LEGS_ONLY -> ModI18n.text("condition.lumenechallenge.armor.legs_only");
            case BOOTS_ONLY -> ModI18n.text("condition.lumenechallenge.armor.boots_only");
        };
    }
