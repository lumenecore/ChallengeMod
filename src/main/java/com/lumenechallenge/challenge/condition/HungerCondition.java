...
public final class HungerCondition extends AbstractCondition {
    ...
    public Text getDescription() {
        if (minFoodLevel == maxFoodLevel) {
            return ModI18n.text("condition.lumenechallenge.hunger.exact", minFoodLevel);
        }
        return ModI18n.text("condition.lumenechallenge.hunger.range", minFoodLevel, maxFoodLevel);
    }
