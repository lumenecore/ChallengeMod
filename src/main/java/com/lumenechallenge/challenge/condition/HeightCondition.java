...
public final class HeightCondition extends AbstractCondition {
    ...
    public Text getDescription() {
        return switch (mode) {
            case RANGE -> ModI18n.text("condition.lumenechallenge.height.range", a, b);
            case EXACT -> ModI18n.text("condition.lumenechallenge.height.exact", a);
            case ABOVE -> ModI18n.text("condition.lumenechallenge.height.above", a);
            case BELOW -> ModI18n.text("condition.lumenechallenge.height.below", a);
            case AIR -> ModI18n.text("condition.lumenechallenge.height.air");
            case ON_BLOCK -> ModI18n.text("condition.lumenechallenge.height.on_block");
        };
    }
