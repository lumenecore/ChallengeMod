...
public final class DimensionCondition extends AbstractCondition {
    ...
    public Text getDescription() {
        return switch (mode) {
            case OVERWORLD -> Text.translatable("condition.lumenechallenge.dimension.overworld");
            case NETHER -> Text.translatable("condition.lumenechallenge.dimension.nether");
            case END -> Text.translatable("condition.lumenechallenge.dimension.end");
        };
    }
