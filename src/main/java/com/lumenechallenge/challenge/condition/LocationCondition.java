...
public final class LocationCondition extends AbstractCondition {
    ...
    public Text getDescription() {
        return switch (mode) {
            case OVERWORLD -> Text.translatable("condition.lumenechallenge.location.overworld");
            case NETHER -> Text.translatable("condition.lumenechallenge.location.nether");
            case END -> Text.translatable("condition.lumenechallenge.location.end");
            case UNDERWATER -> Text.translatable("condition.lumenechallenge.location.underwater");
        };
    }
